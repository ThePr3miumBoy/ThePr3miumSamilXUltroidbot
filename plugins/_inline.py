...
SUP_BUTTONS = [
    [
        Button.url("• Repo •", url="https://github.com/ThePr3miumBoy/ThePr3miumSamilXUltroidbot"),
        Button.url("• Support •", url="t.me/The_Pr3mium_Boy"),
    ],
]
...
async def inline_alive(o):
    TLINK = inline_pic() or "https://graph.org/file/c034f71ff7cdb13ca38c1.jpg"
    MSG = "• **Ultroid Userbot •**"
    WEB0 = InputWebDocument(
        "https://graph.org/file/c034f71ff7cdb13ca38c1.jpg", 0, "image/jpg", []
    )
    RES = [
